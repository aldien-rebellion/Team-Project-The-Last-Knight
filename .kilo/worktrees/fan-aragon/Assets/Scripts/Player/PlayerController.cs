    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void EndDash()
        {
            ...
            if (_kinematicController.IsGrounded)
            {
                ...
                _velocity = new Vector2(moveInputX * MoveSpeed, 0f);
                CurrentState = Mathf.Abs(moveInputX) > 0.01f ? PlayerState.Walking : PlayerState.Idle;
            }
            else
            {
                float moveInputX = _inputHandler != null ? _inputHandler.MoveInput.x : 0f;
        ...
        private void UpdateNormalMovement()
        {
            ...
            float targetXSpeed = moveInputX * MoveSpeed;
        ...
        private void LateUpdate()
        {
            ...
            bool isRunning = CurrentState == PlayerState.Walking;
